...
*/
/*
	write_idblock_rcm44xxw.c

	Example of using WriteIdBlock.lib and WriteIdBlock_RCM44xxW.LIB to write a
	system ID Block to an RCM44xxW board.

	To program an RCM44xxW board which lacks an existing correct and valid system
...
#if RCM4400W == _BOARD_TYPE_
	// add RCM4400W specific, fixed information
	wib_addRCM4400WInfo(build);
#else	// RCM4400W == _BOARD_TYPE_
	#fatal "This sample does not support the current _BOARD_TYPE_ definition."
#endif	// RCM4400W == _BOARD_TYPE_
