...
*/
/*
	write_idblock_rcm67xx.c

	Example of using WriteIdBlock.lib and WriteIdBlock_RCM67xx.lib to write a
	system ID Block to an RCM67xx board.
...
#if RCM6700 == _BOARD_TYPE_
	// add RCM6700 specific, fixed information
	wib_addRCM6700Info(build);
#elif RCM6710 == _BOARD_TYPE_
	// add RCM6710 specific, fixed information
	wib_addRCM6710Info(build);
#elif RCM6720 == _BOARD_TYPE_
	// add RCM6720 specific, fixed information
	wib_addRCM6720Info(build);
#elif RCM6730 == _BOARD_TYPE_
	// add RCM6730 specific, fixed information
	wib_addRCM6730Info(build);
#elif RCM6750 == _BOARD_TYPE_
	// add RCM6750 specific, fixed information
	wib_addRCM6750Info(build);
#elif RCM6760 == _BOARD_TYPE_
	// add RCM6760 specific, fixed information
	wib_addRCM6760Info(build);
#else
