...
_zcl_comm_startup_control_set           <zcl_commissioning.c>

SYNTAX:
   int _zcl_comm_startup_control_set(
...
PARAMETER1:  attribute - should be a pointer to
              zcl_comm_startup_attributes.startup_control
PARAMETER2:  rec - value from write request
...
/*** EndHeader */
/* START _FUNCTION DESCRIPTION *******************************************
_zcl_comm_command_build                 <zcl_commissioning.c>
...
/*** EndHeader */
/* START FUNCTION DESCRIPTION ********************************************
zcl_comm_factory_reset                  <zcl_commissioning.c>
...
PARAMETER1:  ms_delay - initiate reset after <ms_delay> milliseconds
