...
zcl_identify_isactive                   <zcl_identify.c>
...
RETURNS:  >0       - Number of seconds of "Identification mode" left.
...
/*** EndHeader */
/* START FUNCTION DESCRIPTION ********************************************
_zcl_identify_time_set                  <zcl_identify.c>
...
PARAMETER1:  attribute - ignored; assumed to point to zcl_identify_time
PARAMETER2:  rec - value from write request or NULL to update the
...
_zcl_identify_time_get                  <zcl_identify.c>

SYNTAX:
   uint_fast8_t _zcl_identify_time_get(
                                    const zcl_attribute_full_t FAR *attribute)
...
/*** EndHeader */
/* START FUNCTION DESCRIPTION ********************************************
zcl_identify_command                    <zcl_identify.c>
...
RETURNS:  0        - command was processed, including sending a possible
