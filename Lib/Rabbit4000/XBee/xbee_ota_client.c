...
_xbee_ota_xmodem_read                   <xbee_ota_client.c>

SYNTAX:
   int _xbee_ota_xmodem_read( void FAR *context,  void FAR *buffer, 
                              int16_t bytes)

DESCRIPTION:

     Function assigned to the stream.read function pointer of an
     xbee_xmodem_state_t object.  Reads data from the target specified in
     the xbee_ota_t structure.


PARAMETER1:  context - xbee_ota_t structure
...
/* START _FUNCTION DESCRIPTION *******************************************
_xbee_ota_xmodem_write                  <xbee_ota_client.c>
...
DESCRIPTION:
     ...
     Function assigned to the stream.write function pointer of an
     xbee_xmodem_state_t object.  Sends data to the target specified in
     the xbee_ota_t structure.


PARAMETER1:  context - xbee_ota_t structure
PARAMETER2:  buffer - source of data to send
