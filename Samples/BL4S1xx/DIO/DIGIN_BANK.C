...
void update_input(int bank, int end_channel, int col, int row)
{
	char *ptr;
	char display[80];
   ...
   mask = 0x01;
	...
	for(index = 0; index < end_channel; ++index)
   {
...
void main()
{
   ...
   // Configure all inputs to be general digital inputs
	...
	for(;;)
	{
		// update input bank 0, located at col = 8 row = 5.
		update_input(0, 8, 8, 5);

		// update input bank 1, located at col = 8 row = 9.
		update_input(1, 4, 8, 9);
   }
}
///////////////////////////////////////////////////////////////////////////
