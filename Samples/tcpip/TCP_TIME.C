 ...
 *
 * See also RFC2030 for the "real" way to do this -- an implementation
 * of a simple RFC2030 (SNTP) client is provided in SNTP_TIME.C, which is
 * recommended for new code, and is much better supported and more accurate.
 *
 * Anyway, this sample uses UDP to query to a sequence of Time servers.
