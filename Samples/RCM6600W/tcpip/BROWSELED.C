/**********************************************************
   browseled.c
	...
	and digital I/O accessory board, available with the deluxe dev kit.
   ...
   defines):
	...
	accessory board will match the ones on the web page.
   ...
   3. With your Web browser access the Web page running on the controller,
   	such as http://10.10.6.100, using your _PRIMARY_STATIC_IP.
   4. View LEDS on Web page and the interface board, DS1-DS4,
...
#ximport "../../RCM5600W/tcpip/pages/browseled.shtml" index_html
#ximport "../../RCM5600W/tcpip/pages/rabbit1.gif"    	rabbit1_gif
#ximport "../../RCM5600W/tcpip/pages/ledon.gif"      	ledon_gif
#ximport "../../RCM5600W/tcpip/pages/ledoff.gif"     	ledoff_gif
#ximport "../../RCM5600W/tcpip/pages/button.gif"     	button_gif
#ximport "../../RCM5600W/tcpip/pages/showsrc.shtml"  	showsrc_shtml
...
// each time the ledxtog.cgi is requested from the browser.
char led1[15];
char led2[15];
char led3[15];
char led4[15];
...
void ledtoggle(HttpState* state, char *led)
{
   if (strcmp(led,"ledon.gif")==0) {
      strcpy(led,"ledoff.gif");
   }
   else {
